    ...
    <>
      <div className="container-Hero max-h-screen place-items-center">
        <div class="content flex jura-medium">
          <div class="left w-1/2 flex flex-col justify-center h-screen mx-10 p-4">
            ...
            <div class="description text-base text-white my-1">
            ...
            <button className="bg-button-gray hover:bg-color-primary w-36 border-solid border-2 border-button-gray text-white py-2 px-4 rounded-lg my-5">
              Cari Tahu
            </button>
          </div>
